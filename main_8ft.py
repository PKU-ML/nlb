...
from solo.methods.finetune import FinetuneModel
...
def main():
    ...
    if args.dali:
        ...
        Class = types.new_class(f"Dali{FinetuneModel.__name__}", (ClassificationABC, FinetuneModel))
    else:
        Class = FinetuneModel
    ...
    if args.save_checkpoint:
        ...
        ckpt = Checkpointer(
            args,
            logdir='finetune_checkpoint/' + args.name + poison_suffix ,
